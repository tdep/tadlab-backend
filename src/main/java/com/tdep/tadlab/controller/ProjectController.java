...
//    Project
    ...
    @PutMapping("/projects/remove_link/{id}")
    public ResponseEntity<Project> removeLinkFromProject(@PathVariable("id") int id, @RequestBody String name) {
        return projectWriteService.removeLinkFromProject(id, name);
    }
